...
length_plate = 10;  % Length of plate in terms of number of grids  
...
for z = 1:Ni    % Number of iterations
        ...
        for j=2:Ny-1      
            ...
            % potential values for all iterations
                ...
                V(mpy-lp-10:mpy+lp-10,pp1) = 100;
                V(mpy-lp-30:mpy+lp-30,pp1) = 0;
                V(mpy-lp+10:mpy+lp+10,pp1) = 0;
                V(mpy-lp+30:mpy+lp+30,pp1) = 0;
                
                V(mpy-lp-10:mpy+lp-10,pp2) = 0;
                V(mpy-lp-30:mpy+lp-30,pp2) = 0;
                V(mpy-lp+10:mpy+lp+10,pp2) = 0;
                V(mpy-lp+30:mpy+lp+30,pp2) = 0;
